// DocumentOperationRasterImageColorize.h : Declaration of the CDocumentOperationRasterImageColorize
...
class ATL_NO_VTABLE CDocumentOperationRasterImageColorize :
	public CComObjectRootEx<CComMultiThreadModel>,
	public CComCoClass<CDocumentOperationRasterImageColorize, &CLSID_DocumentOperationRasterImageColorize>,
...
DECLARE_NO_REGISTRY()
DECLARE_CLASSFACTORY_SINGLETON(CDocumentOperationRasterImageColorize)

BEGIN_CATEGORY_MAP(CDocumentOperationRasterImageColorize)
	IMPLEMENTED_CATEGORY(CATID_DocumentOperation)
	IMPLEMENTED_CATEGORY(CATID_TagImageColorAdjustment)
END_CATEGORY_MAP()

BEGIN_COM_MAP(CDocumentOperationRasterImageColorize)
...
OBJECT_ENTRY_AUTO(__uuidof(DocumentOperationRasterImageColorize), CDocumentOperationRasterImageColorize)
