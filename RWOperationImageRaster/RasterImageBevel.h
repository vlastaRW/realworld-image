// RasterImageBevel.h : Declaration of the CRasterImageBevel
...
class ATL_NO_VTABLE CRasterImageBevel :
	public CComObjectRootEx<CComMultiThreadModel>,
	public CComCoClass<CRasterImageBevel, &CLSID_RasterImageBevel>,
...
DECLARE_NO_REGISTRY()
DECLARE_CLASSFACTORY_SINGLETON(CRasterImageBevel)

BEGIN_CATEGORY_MAP(CRasterImageBevel)
...
BEGIN_COM_MAP(CRasterImageBevel)
...
public:
	...
	// ILayerStyle methods
public:
	STDMETHOD_(BYTE, ExecutionPriority)() { return ELSEPSatin + 4; }
	STDMETHOD(IsPriorityAnchor)() { return S_FALSE; }
};

OBJECT_ENTRY_AUTO(__uuidof(RasterImageBevel), CRasterImageBevel)
