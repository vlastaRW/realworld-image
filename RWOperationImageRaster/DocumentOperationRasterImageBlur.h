// DocumentOperationRasterImageBlur.h : Declaration of the CDocumentOperationRasterImageBlur
...
class ATL_NO_VTABLE CDocumentOperationRasterImageBlur :
	public CComObjectRootEx<CComMultiThreadModel>,
	public CComCoClass<CDocumentOperationRasterImageBlur, &CLSID_DocumentOperationRasterImageBlur>,
...
DECLARE_NO_REGISTRY()
DECLARE_CLASSFACTORY_SINGLETON(CDocumentOperationRasterImageBlur)

BEGIN_CATEGORY_MAP(CDocumentOperationRasterImageBlur)
	IMPLEMENTED_CATEGORY(CATID_DocumentOperation)
	IMPLEMENTED_CATEGORY(CATID_TagImageOverlay)
END_CATEGORY_MAP()

BEGIN_COM_MAP(CDocumentOperationRasterImageBlur)
...
public:
	...
	// ILayerStyle methods
public:
	STDMETHOD_(BYTE, ExecutionPriority)() { return ELSEPGlow + 2; }
	STDMETHOD(IsPriorityAnchor)() { return S_FALSE; }
};

OBJECT_ENTRY_AUTO(__uuidof(DocumentOperationRasterImageBlur), CDocumentOperationRasterImageBlur)
