// RasterImagePolarTransformation.h : Declaration of the CRasterImagePolarTransformation
...
class ATL_NO_VTABLE CRasterImagePolarTransformation :
	public CComObjectRootEx<CComMultiThreadModel>,
	public CComCoClass<CRasterImagePolarTransformation, &CLSID_RasterImagePolarTransformation>,
...
DECLARE_NO_REGISTRY()
DECLARE_CLASSFACTORY_SINGLETON(CRasterImagePolarTransformation)

BEGIN_CATEGORY_MAP(CRasterImagePolarTransformation)
	IMPLEMENTED_CATEGORY(CATID_DocumentOperation)
	IMPLEMENTED_CATEGORY(CATID_TagImageTransformation)
END_CATEGORY_MAP()

BEGIN_COM_MAP(CRasterImagePolarTransformation)
...
OBJECT_ENTRY_AUTO(__uuidof(RasterImagePolarTransformation), CRasterImagePolarTransformation)
