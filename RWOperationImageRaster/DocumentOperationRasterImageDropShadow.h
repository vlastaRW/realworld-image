// DocumentOperationRasterImageDropShadow.h : Declaration of the CDocumentOperationRasterImageDropShadow
...
class ATL_NO_VTABLE CDocumentOperationRasterImageDropShadow :
	public CComObjectRootEx<CComMultiThreadModel>,
	public CComCoClass<CDocumentOperationRasterImageDropShadow, &CLSID_DocumentOperationRasterImageDropShadow>,
...
DECLARE_NO_REGISTRY()
DECLARE_CLASSFACTORY_SINGLETON(CDocumentOperationRasterImageDropShadow)

BEGIN_CATEGORY_MAP(CDocumentOperationRasterImageDropShadow)
...
BEGIN_COM_MAP(CDocumentOperationRasterImageDropShadow)
...
OBJECT_ENTRY_AUTO(__uuidof(DocumentOperationRasterImageDropShadow), CDocumentOperationRasterImageDropShadow)
