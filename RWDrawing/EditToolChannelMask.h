...
class CEditToolChannelMask :
	public CComObjectRootEx<CComMultiThreadModel>,
	public IRasterImageEditTool,
	public IRasterImageEditWindow
{
public:
	CEditToolChannelMask() : m_pCallback(NULL)
	{
	}
	~CEditToolChannelMask()
	{
		m_pTool = NULL;
		if (m_pCallback)
		{
	...
	{
		CEditToolChannelMask* const p = reinterpret_cast<CEditToolChannelMask*>(pv);
		if (p->m_pTool)
			return p->m_pTool->QueryInterface(riid, ppv);
		return E_NOINTERFACE;
	}

	BEGIN_COM_MAP(CEditToolChannelMask)
