...
#define PERFMON
#include "../RWViewImageRendered/RasterImagePainting.h"
#include "../RWViewImageRendered/RasterImageMouseInput.h"
...
//#include "..\..\..\_extlibs\agg2\src\agg_vcgen_dash.cpp"
//#include "..\..\..\_extlibs\agg2\src\agg_vcgen_stroke.cpp"
#include "..\..\..\_extlibs\agg2\include\agg_renderer_outline_image.h"
#include "..\..\..\_extlibs\agg2\include\agg_rasterizer_outline_aa.h"
#include "..\..\..\_extlibs\agg2\include\agg_pattern_filters_rgba.h"  // for all rgba-8-bit color formats
#include "..\..\..\_extlibs\agg2\src\agg_line_aa_basics.cpp"
...
static BYTE const CONTROLPOINT9x9[] =
{
	,
};

static BYTE const CONTROLPOINT11x11[] =
{
	,
};

static BYTE const CONTROLPOINT13x13[] =
{
	,
};

class ATL_NO_VTABLE CDesignerViewLayeredImageEditor;

struct SGestureOperationEffect
{
	wchar_t const* pszName;
	GUID tID;
	HRESULT (CDesignerViewLayeredImageEditor::*pMemFun)(IConfig* a_pCfg);
...
// CDesignerViewLayeredImageEditor

class ATL_NO_VTABLE CDesignerViewLayeredImageEditor : 
	public CComObjectRootEx<CComMultiThreadModel>,
	public CWindowImpl<CDesignerViewLayeredImageEditor>,
	public CThemeImpl<CDesignerViewLayeredImageEditor>,
	public CDesignerViewWndImpl<CDesignerViewLayeredImageEditor, IDesignerView>,
	public CObserverImpl<CDesignerViewLayeredImageEditor, IImageObserver, TImageChange>,
	public CObserverImpl<CDesignerViewLayeredImageEditor, ISharedStateObserver, TSharedStateChange>,
	public CObserverImpl<CDesignerViewLayeredImageEditor, ILayerEffectObserver, ULONG>,
	public IDesignerViewStatusBar,
	public CContextMenuWithIcons<CDesignerViewLayeredImageEditor>,
	public CRasterImagePainting<CDesignerViewLayeredImageEditor>,
	public CRasterImageMouseInput<CDesignerViewLayeredImageEditor>
{
public:
	CDesignerViewLayeredImageEditor() : m_nWheelDelta(0), m_dwVisibleHandles(0),
	...
	void Init(ISharedStateManager* a_pFrame, IStatusBarObserver* a_pStatusBar, IConfig* a_pConfig, RWHWND a_hParent, const RECT* a_rcWindow, EDesignerViewWndStyle a_nStyle, LCID a_tLocaleID, IDocument* a_pDoc, IViewManager* a_pViewManager, IDocumentImage* a_pImage)
	{
		...
		if (m_pStateMgr)
		{
			...
			m_pStateMgr->ObserverIns(CObserverImpl<CDesignerViewLayeredImageEditor, ISharedStateObserver, TSharedStateChange>::ObserverGet(), 0);
		}

		m_pImage->ObserverIns(CObserverImpl<CDesignerViewLayeredImageEditor, IImageObserver, TImageChange>::ObserverGet(), 0);
		if (m_pImageEffect)
			m_pImageEffect->ObserverIns(CObserverImpl<CDesignerViewLayeredImageEditor, ILayerEffectObserver, ULONG>::ObserverGet(), 0);

		m_pStatusBar = a_pStatusBar;

		//m_dwLastMessage = GetTickCount()-50000;
		// create self
		if (Create(a_hParent, const_cast<LPRECT>(a_rcWindow), _T("LayeredEditFrame"), WS_CHILD | WS_VISIBLE | WS_CLIPCHILDREN | WS_CLIPSIBLINGS, (a_nStyle&EDVWSBorderMask) != EDVWSBorder ? 0 : WS_EX_CLIENTEDGE) == NULL)
		{
			// creation failed
	...
	DECLARE_WND_CLASS_EX(_T("RWViewLayeredEditor"), CS_OWNDC | CS_VREDRAW | CS_HREDRAW, COLOR_WINDOW);

	enum { SCROLL_TIMERID = 21, SCROLL_TICK = 100, TABLETBLOCKTIME = 500, WM_RW_UPDATETOOLCMDLINE = WM_APP+278 };

BEGIN_MSG_MAP(CDesignerViewLayeredImageEditor)
	CHAIN_MSG_MAP(CThemeImpl<CDesignerViewLayeredImageEditor>)
	CHAIN_MSG_MAP(CRasterImagePainting<CDesignerViewLayeredImageEditor>)
	CHAIN_MSG_MAP(CRasterImageMouseInput<CDesignerViewLayeredImageEditor>)
...
//MESSAGE_HANDLER(WM_SIZE, OnSize)
	...
	CHAIN_MSG_MAP(CContextMenuWithIcons<CDesignerViewLayeredImageEditor>)
END_MSG_MAP()

BEGIN_COM_MAP(CDesignerViewLayeredImageEditor)
...
END_COM_MAP()
	...
	{
		if (m_pImage)
			m_pImage->ObserverDel(CObserverImpl<CDesignerViewLayeredImageEditor, IImageObserver, TImageChange>::ObserverGet(), 0);
		if (m_pStateMgr)
			m_pStateMgr->ObserverDel(CObserverImpl<CDesignerViewLayeredImageEditor, ISharedStateObserver, TSharedStateChange>::ObserverGet(), 0);
		if (m_pImageEffect)
			m_pImageEffect->ObserverDel(CObserverImpl<CDesignerViewLayeredImageEditor, ILayerEffectObserver, ULONG>::ObserverGet(), 0);
	}
	...
	void OwnerNotify(TCookie a_tCookie, ULONG a_dwFlags)
	{
		...
		try
		{
			if (a_dwFlags&(ELECOpCfg|ELECOpID))
			{
				...
				GetDifferentHandles(m_pWrapper, pNew, cHandles);
...
public:
	...
	bool TestHandle(POINT const& a_tPos, ULONG* a_pIndex) const
	{
		...
		float const fRadSq = (m_nHandleRadius+0.5f)*(m_nHandleRadius+0.5f);
	...
	bool TestHandle(TPixelCoords const& a_tPos, ULONG* a_pIndex) const
	{
		if (m_pWrapper == NULL)
			return false;
		float const fRadSq = (m_nHandleRadius+0.5f)*(m_nHandleRadius+0.5f)/M_ImageZoom()/M_ImageZoom();
		//for (CHandles::const_reverse_iterator i = m_cHandles.rbegin(); i != m_cHandles.rend(); ++i)
		for (ULONG i = m_pWrapper->GetControlPointCount(); i > 0; )
		{
			--i;
	...
	void DrawHelpLines(CHelpLines const& cHelpLines, float fZoomX, float fZoomY, RECT const& a_rcDirty, COLORREF* a_pBuffer, ULONG a_nStride)
	{
	...
	void PostRenderImage(RECT const& a_rcImage, ULONG a_nWindowX, ULONG a_nWindowY, RECT const& a_rcDirty, COLORREF* a_pBuffer, ULONG a_nStride)
	{
		...
		if (m_pWrapper)
		{
			...
			cReceiver.Init(cHL, 10.0f);
			m_pWrapper->GetControlLines(&cReceiver, 0);
			DrawHelpLines(cHL, fZoomX, fZoomY, a_rcDirty, a_pBuffer, a_nStride);

			ULONG const nHandles = m_pWrapper->GetControlPointCount();
			// draw handles
			for (ULONG i = 0; i < nHandles; ++i)
			{
				TPixelCoords tPos;
				ULONG nClass;
				m_pWrapper->GetControlPoint(i, &tPos, &nClass);
	...
	void GetPixelFromPoint(POINT a_tPoint, TPixelCoords* a_pPixel, TPixelCoords* a_pPointerSize = NULL, ULONG const* a_pControlPointIndex = NULL, EControlKeysState a_eKeysState = ECKSNone) const
	{
		float const fZoomX = float(M_ZoomedSize().cx)/float(M_ImageSize().cx);
		float const fZoomY = float(M_ZoomedSize().cy)/float(M_ImageSize().cy);
		a_pPixel->fX = (a_tPoint.x - M_ImagePos().x) / fZoomX;
		a_pPixel->fY = (a_tPoint.y - M_ImagePos().y) / fZoomY;
	...
	void ProcessInputEvent(EControlKeysState a_eKeysState, TPixelCoords const* a_pPos, TPixelCoords const* a_pPointerSize, float a_fNormalPressure, float a_fTangentPressure, float a_fOrientation, float a_fRotation, float a_fZ, DWORD* a_pMaxIdleTime)
	{
		...
		if (m_pDragged)
		{
			bool bReleased = a_fNormalPressure < 0.333f;
			CComPtr<ICanvasInteractingWrapper> pNew;
			ULONG nHandle = m_nDraggedHandle;
			m_pDragged->SetControlPoint(m_nDraggedHandle, a_pPos, bReleased, (m_nHandleRadius+0.5f)/M_ImageZoom(), &pNew, &nHandle);
			...
			//CopyConfigValues(pMem, m_pOpCfg);
			...
			{
				//m_nDraggedHandle = nHandle;
				m_pWrapper = pNew;
			}
		}
		else // not dragging handle
		{
...
public:
	...
	public:
		...
		void Init(IOperationManager* a_pManager, CDesignerViewLayeredImageEditor* a_pView, bool a_bDeactivate = true)
		{
	...
	public:
		...
		void GetGOs(SGestureOperationEffect const** first, SGestureOperationEffect const** last)
		{
			...
			{
				{L"[0409]Gestures - Undo[0405]Gesta - zpět", {0xe2338bc9, 0x2091, 0x4f7f, {0x85, 0xde, 0xbd, 0xa5, 0x12, 0x3f, 0x5b, 0x9f}}, &CDesignerViewLayeredImageEditor::GestureUndo, NULL },
				{L"[0409]Gestures - Redo[0405]Gesta - vpřed", {0x80f0f964, 0x6a19, 0x4952, {0xbd, 0xd9, 0x2d, 0xc4, 0xa1, 0x09, 0x54, 0x90}}, &CDesignerViewLayeredImageEditor::GestureRedo, NULL },
				//{L"[0409]Gestures - Apply[0405]Gesta - dokončit kreslení", {0xac6edf28, 0x16c7, 0x48b5, {0xba, 0x0d, 0x00, 0x39, 0x04, 0xef, 0x78, 0x22}}, &CDesignerViewLayeredImageEditor::GestureApply, NULL },
				...
				{L"[0409]Gestures - Automatic Zoom[0405]Gesta - automatické zvětšení", {0x9c8d8a7d, 0x4184, 0x4849, {0xa4, 0x3b, 0x82, 0x09, 0xec, 0x9a, 0x3d, 0x2a}}, &CDesignerViewLayeredImageEditor::GestureAutoZoom, NULL },
	...
	private:
		...
		CDesignerViewLayeredImageEditor* m_pView;
		bool m_bDeactivate;
	};
...
private:
	...
	void InitPaintConstants()
	{
		...
		{
			m_nHandleRadius = 6;
			m_pHandleImage = CONTROLPOINT13x13;
		}
		else if (nDPI >= 120)
		{
			m_nHandleRadius = 5;
			m_pHandleImage = CONTROLPOINT11x11;
		}
		else
		{
			m_nHandleRadius = 4;
			m_pHandleImage = CONTROLPOINT9x9;
		}
	}
	...
	static void WrapperToHandles(ICanvasInteractingWrapper* pWrapper, CControlHandles& cHandles)
	{
		...
		std::sort(cHandles.begin(), cHandles.end());
	}
	static void GetDifferentHandles(ICanvasInteractingWrapper* pOld, ICanvasInteractingWrapper* pNew, CControlHandles& cHandles)
	{
		CControlHandles cOld;
		WrapperToHandles(pOld, cOld);
		CControlHandles cNew;
		WrapperToHandles(pNew, cNew);
		std::set_symmetric_difference(cOld.begin(), cOld.end(), cNew.begin(), cNew.end(), std::back_inserter(cHandles));
	}
	void InvalidateHandles(CControlHandles const& cHandles)
	{
		...
		rc.left -= m_nHandleRadius;
		rc.top -= m_nHandleRadius;
		rc.right += m_nHandleRadius+1;
		rc.bottom += m_nHandleRadius+1;
...
// CDesignerViewFactoryLayeredImageEditor

class ATL_NO_VTABLE CDesignerViewFactoryLayeredImageEditor :
	public CComObjectRootEx<CComMultiThreadModel>,
	public CComCoClass<CDesignerViewFactoryLayeredImageEditor>,
...
DECLARE_NO_REGISTRY()
DECLARE_CLASSFACTORY_SINGLETON(CDesignerViewFactoryLayeredImageEditor)

BEGIN_CATEGORY_MAP(CDesignerViewFactoryLayeredImageEditor)
	IMPLEMENTED_CATEGORY(CATID_DesignerViewFactory)
END_CATEGORY_MAP()

BEGIN_COM_MAP(CDesignerViewFactoryLayeredImageEditor)
...
public:
	STDMETHOD(NameGet)(IViewManager* a_pManager, ILocalizedString** a_ppName)
	{
		...
		try
		{
			*a_ppName = new CMultiLanguageString(L"[0409]Layered Image - Editor[0405]Vrstvený obrázek - editor");
			return S_OK;
		}
		catch (...)
		{
	...
	STDMETHOD(ConfigCreate)(IViewManager* a_pManager, IConfig** a_ppDefaultConfig)
	{
		...
		try
		{
			*a_ppDefaultConfig = NULL;
			...
			pCfgInit->ItemInsSimple(CComBSTR(CFGID_IMGEDIT_STARTWITHAUTOZOOM), CMultiLanguageString::GetAuto(L"[0409]Auto-zoom[0405]Automatické zvětšení"), CMultiLanguageString::GetAuto(L"[0409][0405]"), CConfigValue(true), NULL, 0, NULL);
			...
			pCfgInit->ItemInsSimple(CComBSTR(CFGID_IMGEDIT_RENDERINGMODE), NULL, NULL, CConfigValue(LONG(EIQCoverage)), NULL, 0, NULL);
			pCfgInit->ItemInsSimple(CComBSTR(CFGID_IMGEDIT_COMPOSED), NULL, NULL, CConfigValue(LONG(EICFinalImage)), NULL, 0, NULL);
			pCfgInit->ItemInsSimple(CComBSTR(CFGID_IMGEDIT_INVERTED), NULL, NULL, CConfigValue(false), NULL, 0, NULL);
			CComBSTR cCFGID_2DEDIT_GRID(CFGID_IMGEDIT_GRID);
			pCfgInit->ItemIns1ofN(cCFGID_2DEDIT_GRID, NULL, NULL, CConfigValue(CFGVAL_2DEDIT_GRID8x8), NULL);
			pCfgInit->ItemOptionAdd(cCFGID_2DEDIT_GRID, CConfigValue(CFGVAL_2DEDIT_GRID1x1), NULL, 0, NULL);
			pCfgInit->ItemOptionAdd(cCFGID_2DEDIT_GRID, CConfigValue(CFGVAL_2DEDIT_GRID8x8), NULL, 0, NULL);
			pCfgInit->ItemOptionAdd(cCFGID_2DEDIT_GRID, CConfigValue(CFGVAL_2DEDIT_GRIDOFF), NULL, 0, NULL);
			CComBSTR cCFGID_IMGEDIT_STYLE(CFGID_IMGEDIT_STYLE);
			pCfgInit->ItemIns1ofN(cCFGID_IMGEDIT_STYLE, NULL, NULL, CConfigValue(CFGVAL_2DEDIT_STYLECLASSIC), NULL);
			pCfgInit->ItemOptionAdd(cCFGID_IMGEDIT_STYLE, CConfigValue(CFGVAL_2DEDIT_STYLECLASSIC), NULL, 0, NULL);
			pCfgInit->ItemOptionAdd(cCFGID_IMGEDIT_STYLE, CConfigValue(CFGVAL_2DEDIT_STYLECLEAN), NULL, 0, NULL);
			//pCfgInit->ItemOptionAdd(cCFGID_IMGEDIT_STYLE, CConfigValue(CFGVAL_2DEDIT_STYLEGLASS), NULL, 0, NULL);
			pCfgInit->ItemInsSimple(CComBSTR(CFGID_IMGEDIT_HANDLESIZE), NULL, NULL, CConfigValue(4.0f), NULL, 0, NULL);
			...
			CComObject<CDesignerViewLayeredImageEditor::CGestureOperationManager>* pGestureOpMgr = NULL;
			CComObject<CDesignerViewLayeredImageEditor::CGestureOperationManager>::CreateInstance(&pGestureOpMgr);
			CComPtr<IOperationManager> pGestureOperations = pGestureOpMgr;
	...
	STDMETHOD(CreateWnd)(IViewManager* a_pManager, IConfig* a_pConfig, ISharedStateManager* a_pFrame, IStatusBarObserver* a_pStatusBar, IDocument* a_pDoc, RWHWND a_hParent, RECT const* a_prcWindow, EDesignerViewWndStyle a_nStyle, LCID a_tLocaleID, IDesignerView** a_ppDVWnd)
	{
		...
		try
		{
			CComObject<CDesignerViewLayeredImageEditor>* pWnd = NULL;
			CComObject<CDesignerViewLayeredImageEditor>::CreateInstance(&pWnd);
...
// {CDF57DFE-3623-42BE-A587-1BB30726A441}
static const GUID CLSID_DesignerViewFactoryLayeredImageEditor = {0xcdf57dfe, 0x3623, 0x42be, {0xa5, 0x87, 0x1b, 0xb3, 0x07, 0x26, 0xa4, 0x41}};

OBJECT_ENTRY_AUTO(CLSID_DesignerViewFactoryLayeredImageEditor, CDesignerViewFactoryLayeredImageEditor)
*/