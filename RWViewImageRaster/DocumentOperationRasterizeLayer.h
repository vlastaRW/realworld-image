// DocumentOperationRasterizeLayer.h : Declaration of the CDocumentOperationRasterizeLayer
...
class ATL_NO_VTABLE CDocumentOperationRasterizeLayer :
	public CComObjectRootEx<CComMultiThreadModel>,
	public CComCoClass<CDocumentOperationRasterizeLayer, &CLSID_DocumentOperationRasterizeLayer>,
...
DECLARE_NO_REGISTRY()
DECLARE_CLASSFACTORY_SINGLETON(CDocumentOperationRasterizeLayer)

BEGIN_CATEGORY_MAP(CDocumentOperationRasterizeLayer)
	IMPLEMENTED_CATEGORY(CATID_DocumentOperation)
END_CATEGORY_MAP()

BEGIN_COM_MAP(CDocumentOperationRasterizeLayer)
...
OBJECT_ENTRY_AUTO(__uuidof(DocumentOperationRasterizeLayer), CDocumentOperationRasterizeLayer)
