...
public:
   ...
   LRESULT OnCreate(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& bHandled)
   {
	  ...
	  m_wndList.Create(this, 2, m_hWnd, &rc, NULL, WS_POPUP | WS_BORDER | WS_VSCROLL | LBS_COMBOBOX, WS_EX_NOACTIVATE|WS_EX_TOPMOST);
      ATLASSERT(m_wndList.IsWindow());
   ...
   LRESULT OnButtonClicked(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/)
   {
      ...
      m_wndList.SetWindowPos(HWND_TOP, &rc, SWP_SHOWWINDOW|SWP_NOACTIVATE);
      return 0;
   }
