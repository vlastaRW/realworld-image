...
static const ExifIndexedValues list[] = {
...
ExifIndexedValues const* exif_get_indexedvalues_table()
{
	return list;
}

static const ExifEnumeratedValues list2[] = {
#ifndef NO_VERBOSE_TAG_DATA
...
ExifEnumeratedValues const* exif_get_enumeratedvalues_table()
{
	return list2;
}
