// DesignerViewFactoryImage.h : Declaration of the CDesignerViewFactoryImage
...
class ATL_NO_VTABLE CDesignerViewFactoryImage : 
	public CComObjectRootEx<CComMultiThreadModel>,
	public CComCoClass<CDesignerViewFactoryImage, &CLSID_DesignerViewFactoryImage>,
...
DECLARE_NO_REGISTRY()
DECLARE_CLASSFACTORY_SINGLETON(CDesignerViewFactoryImage)

BEGIN_CATEGORY_MAP(CDesignerViewFactoryImage)
	IMPLEMENTED_CATEGORY(CATID_DesignerViewFactory)
END_CATEGORY_MAP()

BEGIN_COM_MAP(CDesignerViewFactoryImage)
...
OBJECT_ENTRY_AUTO(__uuidof(DesignerViewFactoryImage), CDesignerViewFactoryImage)
