// DocumentOperationRasterImageGlow.h : Declaration of the CDocumentOperationRasterImageGlow
...
class ATL_NO_VTABLE CDocumentOperationRasterImageGlow :
	public CComObjectRootEx<CComMultiThreadModel>,
	public CComCoClass<CDocumentOperationRasterImageGlow, &CLSID_DocumentOperationRasterImageGlow>,
...
DECLARE_NO_REGISTRY()
DECLARE_CLASSFACTORY_SINGLETON(CDocumentOperationRasterImageGlow)

BEGIN_CATEGORY_MAP(CDocumentOperationRasterImageGlow)
...
BEGIN_COM_MAP(CDocumentOperationRasterImageGlow)
...
OBJECT_ENTRY_AUTO(__uuidof(DocumentOperationRasterImageGlow), CDocumentOperationRasterImageGlow)
